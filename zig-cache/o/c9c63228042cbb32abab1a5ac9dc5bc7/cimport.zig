...
pub const struct_ma_context_config = extern struct {
    ...
    alsa: struct_unnamed_13 = @import("std").mem.zeroes(struct_unnamed_13),
    pulse: struct_unnamed_14 = @import("std").mem.zeroes(struct_unnamed_14),
    coreaudio: struct_unnamed_15 = @import("std").mem.zeroes(struct_unnamed_15),
    jack: struct_unnamed_16 = @import("std").mem.zeroes(struct_unnamed_16),
...
const struct_unnamed_17 = extern struct {
    ...
    linear: struct_unnamed_18 = @import("std").mem.zeroes(struct_unnamed_18),
};
...
const struct_unnamed_22 = extern struct {
    pPCMPlayback: ma_ptr = @import("std").mem.zeroes(ma_ptr),
    pPCMCapture: ma_ptr = @import("std").mem.zeroes(ma_ptr),
    pPollDescriptorsPlayback: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    pPollDescriptorsCapture: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    pollDescriptorCountPlayback: c_int = @import("std").mem.zeroes(c_int),
    pollDescriptorCountCapture: c_int = @import("std").mem.zeroes(c_int),
    wakeupfdPlayback: c_int = @import("std").mem.zeroes(c_int),
    wakeupfdCapture: c_int = @import("std").mem.zeroes(c_int),
    isUsingMMapPlayback: ma_bool8 = @import("std").mem.zeroes(ma_bool8),
    isUsingMMapCapture: ma_bool8 = @import("std").mem.zeroes(ma_bool8),
};
const struct_unnamed_23 = extern struct {
    pMainLoop: ma_ptr = @import("std").mem.zeroes(ma_ptr),
    pPulseContext: ma_ptr = @import("std").mem.zeroes(ma_ptr),
...
const struct_unnamed_24 = extern struct {
    pClient: ma_ptr = @import("std").mem.zeroes(ma_ptr),
    ppPortsPlayback: [*c]ma_ptr = @import("std").mem.zeroes([*c]ma_ptr),
    ppPortsCapture: [*c]ma_ptr = @import("std").mem.zeroes([*c]ma_ptr),
    pIntermediaryBufferPlayback: [*c]f32 = @import("std").mem.zeroes([*c]f32),
    pIntermediaryBufferCapture: [*c]f32 = @import("std").mem.zeroes([*c]f32),
};
...
const union_unnamed_21 = extern union {
    alsa: struct_unnamed_22,
    pulse: struct_unnamed_23,
    jack: struct_unnamed_24,
    null_device: struct_unnamed_25,
};
pub const struct_ma_device = extern struct {
    ...
    resampling: struct_unnamed_17 = @import("std").mem.zeroes(struct_unnamed_17),
    playback: struct_unnamed_19 = @import("std").mem.zeroes(struct_unnamed_19),
    capture: struct_unnamed_20 = @import("std").mem.zeroes(struct_unnamed_20),
...
pub const struct_ma_device_config = extern struct {
    ...
    playback: struct_unnamed_27 = @import("std").mem.zeroes(struct_unnamed_27),
    capture: struct_unnamed_28 = @import("std").mem.zeroes(struct_unnamed_28),
    wasapi: struct_unnamed_29 = @import("std").mem.zeroes(struct_unnamed_29),
    alsa: struct_unnamed_30 = @import("std").mem.zeroes(struct_unnamed_30),
    pulse: struct_unnamed_31 = @import("std").mem.zeroes(struct_unnamed_31),
    coreaudio: struct_unnamed_32 = @import("std").mem.zeroes(struct_unnamed_32),
    opensl: struct_unnamed_33 = @import("std").mem.zeroes(struct_unnamed_33),
    aaudio: struct_unnamed_34 = @import("std").mem.zeroes(struct_unnamed_34),
};
...
const struct_unnamed_36 = extern struct {
    asoundSO: ma_handle = @import("std").mem.zeroes(ma_handle),
    snd_pcm_open: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_close: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_sizeof: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_any: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_format: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_format_first: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_format_mask: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_channels: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_channels_near: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_channels_minmax: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_rate_resample: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_rate: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_rate_near: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_buffer_size_near: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_periods_near: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_set_access: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_format: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_channels: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_channels_min: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_channels_max: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_rate: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_rate_min: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_rate_max: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_buffer_size: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_periods: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_get_access: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_test_format: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_test_channels: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params_test_rate: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_hw_params: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params_sizeof: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params_current: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params_get_boundary: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params_set_avail_min: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params_set_start_threshold: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params_set_stop_threshold: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_sw_params: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_format_mask_sizeof: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_format_mask_test: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_get_chmap: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_state: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_prepare: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_start: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_drop: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_drain: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_reset: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_device_name_hint: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_device_name_get_hint: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_card_get_index: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_device_name_free_hint: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_mmap_begin: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_mmap_commit: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_recover: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_readi: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_writei: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_avail: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_avail_update: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_wait: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_nonblock: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_info: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_info_sizeof: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_info_get_name: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_poll_descriptors: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_poll_descriptors_count: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_pcm_poll_descriptors_revents: ma_proc = @import("std").mem.zeroes(ma_proc),
    snd_config_update_free_global: ma_proc = @import("std").mem.zeroes(ma_proc),
    internalDeviceEnumLock: ma_mutex = @import("std").mem.zeroes(ma_mutex),
    useVerboseDeviceEnumeration: ma_bool32 = @import("std").mem.zeroes(ma_bool32),
};
const struct_unnamed_37 = extern struct {
    pulseSO: ma_handle = @import("std").mem.zeroes(ma_handle),
    pa_mainloop_new: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_mainloop_free: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_mainloop_quit: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_mainloop_get_api: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_mainloop_iterate: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_mainloop_wakeup: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_new: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_free: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_start: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_stop: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_lock: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_unlock: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_wait: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_signal: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_accept: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_get_retval: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_get_api: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_in_thread: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_threaded_mainloop_set_name: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_new: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_unref: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_connect: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_disconnect: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_set_state_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_get_state: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_get_sink_info_list: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_get_source_info_list: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_get_sink_info_by_name: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_context_get_source_info_by_name: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_operation_unref: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_operation_get_state: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_channel_map_init_extend: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_channel_map_valid: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_channel_map_compatible: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_new: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_unref: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_connect_playback: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_connect_record: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_disconnect: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_get_state: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_get_sample_spec: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_get_channel_map: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_get_buffer_attr: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_set_buffer_attr: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_get_device_name: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_set_write_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_set_read_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_set_suspended_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_set_moved_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_is_suspended: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_flush: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_drain: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_is_corked: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_cork: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_trigger: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_begin_write: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_write: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_peek: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_drop: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_writable_size: ma_proc = @import("std").mem.zeroes(ma_proc),
    pa_stream_readable_size: ma_proc = @import("std").mem.zeroes(ma_proc),
    pMainLoop: ma_ptr = @import("std").mem.zeroes(ma_ptr),
    pPulseContext: ma_ptr = @import("std").mem.zeroes(ma_ptr),
    pApplicationName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    pServerName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
};
const struct_unnamed_38 = extern struct {
    jackSO: ma_handle = @import("std").mem.zeroes(ma_handle),
    jack_client_open: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_client_close: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_client_name_size: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_set_process_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_set_buffer_size_callback: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_on_shutdown: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_get_sample_rate: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_get_buffer_size: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_get_ports: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_activate: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_deactivate: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_connect: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_port_register: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_port_name: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_port_get_buffer: ma_proc = @import("std").mem.zeroes(ma_proc),
    jack_free: ma_proc = @import("std").mem.zeroes(ma_proc),
    pClientName: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    tryStartServer: ma_bool32 = @import("std").mem.zeroes(ma_bool32),
};
...
const union_unnamed_35 = extern union {
    alsa: struct_unnamed_36,
    pulse: struct_unnamed_37,
    jack: struct_unnamed_38,
    null_backend: struct_unnamed_39,
};
const struct_unnamed_41 = extern struct {
    _unused: c_int = @import("std").mem.zeroes(c_int),
};
const union_unnamed_40 = extern union {
    posix: struct_unnamed_41,
    _unused: c_int,
};
...
pub const struct___va_list_tag_42 = extern struct {
    gp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    fp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    overflow_arg_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    reg_save_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const __builtin_va_list = [1]struct___va_list_tag_42;
...
pub extern fn ma_log_postv(pLog: [*c]ma_log, level: ma_uint32, pFormat: [*c]const u8, args: [*c]struct___va_list_tag_42) ma_result;
...
pub const ma_linear_resampler = extern struct {
    ...
    x0: union_unnamed_43 = @import("std").mem.zeroes(union_unnamed_43),
    x1: union_unnamed_44 = @import("std").mem.zeroes(union_unnamed_44),
...
pub const ma_resampler = extern struct {
    ...
    sampleRateIn: ma_uint32 = @import("std").mem.zeroes(ma_uint32),
    sampleRateOut: ma_uint32 = @import("std").mem.zeroes(ma_uint32),
    state: union_unnamed_45 = @import("std").mem.zeroes(union_unnamed_45),
    _pHeap: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _ownsHeap: ma_bool32 = @import("std").mem.zeroes(ma_bool32),
};
...
pub const ma_channel_converter = extern struct {
    ...
    weights: union_unnamed_46 = @import("std").mem.zeroes(union_unnamed_46),
    _pHeap: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _ownsHeap: ma_bool32 = @import("std").mem.zeroes(ma_bool32),
};
...
const union_unnamed_51 = extern union {
    loadDataBufferNode: struct_unnamed_52,
    freeDataBufferNode: struct_unnamed_53,
    pageDataBufferNode: struct_unnamed_54,
    loadDataBuffer: struct_unnamed_55,
    freeDataBuffer: struct_unnamed_56,
    loadDataStream: struct_unnamed_57,
    freeDataStream: struct_unnamed_58,
    pageDataStream: struct_unnamed_59,
    seekDataStream: struct_unnamed_60,
};
...
const union_unnamed_62 = extern union {
    reroute: struct_unnamed_63,
};
const union_unnamed_61 = extern union {
    aaudio: union_unnamed_62,
};
const union_unnamed_49 = extern union {
    custom: struct_unnamed_50,
    resourceManager: union_unnamed_51,
    device: union_unnamed_61,
};
pub const struct_ma_job = extern struct {
    toc: union_unnamed_47 = @import("std").mem.zeroes(union_unnamed_47),
    next: ma_uint64 align(8) = @import("std").mem.zeroes(ma_uint64),
    order: ma_uint32 = @import("std").mem.zeroes(ma_uint32),
    data: union_unnamed_49 = @import("std").mem.zeroes(union_unnamed_49),
};
...
const union_unnamed_64 = extern union {
    started: struct_unnamed_65,
    stopped: struct_unnamed_66,
    rerouted: struct_unnamed_67,
    interruption: struct_unnamed_68,
};
pub const ma_device_notification = extern struct {
    ...
    data: union_unnamed_64 = @import("std").mem.zeroes(union_unnamed_64),
};
...
pub const ma_device_info = extern struct {
    ...
    nativeDataFormats: [64]struct_unnamed_70 = @import("std").mem.zeroes([64]struct_unnamed_70),
};
...
const union_unnamed_71 = extern union {
    quit: struct_unnamed_72,
    createAudioClient: struct_unnamed_73,
    releaseAudioClient: struct_unnamed_74,
};
...
const union_unnamed_75 = extern union {
    vfs: struct_unnamed_76,
    memory: struct_unnamed_77,
};
pub const struct_ma_decoder = extern struct {
    ...
    inputCacheRemaining: ma_uint64 = @import("std").mem.zeroes(ma_uint64),
    allocationCallbacks: ma_allocation_callbacks = @import("std").mem.zeroes(ma_allocation_callbacks),
    data: union_unnamed_75 = @import("std").mem.zeroes(union_unnamed_75),
};
...
const union_unnamed_80 = extern union {
    pink: struct_unnamed_81,
    brownian: struct_unnamed_82,
};
pub const ma_noise = extern struct {
    ...
    state: union_unnamed_80 = @import("std").mem.zeroes(union_unnamed_80),
    _pHeap: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    _ownsHeap: ma_bool32 = @import("std").mem.zeroes(ma_bool32),
};
...
pub const struct_ma_resource_manager_data_buffer = extern struct {
    ...
    connector: union_unnamed_83 = @import("std").mem.zeroes(union_unnamed_83),
};
...
const union_unnamed_85 = extern union {
    encoded: struct_unnamed_86,
    decoded: struct_unnamed_87,
    decodedPaged: struct_unnamed_88,
};
pub const ma_resource_manager_data_supply = extern struct {
    ...
    backend: union_unnamed_85 = @import("std").mem.zeroes(union_unnamed_85),
};
...
pub const struct_ma_node_graph = extern struct {
    ...
    nodeCacheCapInFrames: ma_uint16 = @import("std").mem.zeroes(ma_uint16),
...
pub const ma_engine_node = extern struct {
    ...
    fadeSettings: struct_unnamed_89 = @import("std").mem.zeroes(struct_unnamed_89),
    _ownsHeap: ma_bool8 = @import("std").mem.zeroes(ma_bool8),
    _pHeap: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
...
pub const MA_STRINGIFY = @compileError("unable to translate C expr: unexpected token '#'"); // /home/faouzi/miniaudio/miniaudio.h:3721:9
pub const MA_VERSION_STRING = @compileError("unable to translate C expr: unexpected token 'a string literal'"); // /home/faouzi/miniaudio/miniaudio.h:3727:9
pub const offsetof = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /snap/zig/10276/lib/include/stddef.h:116:9
...
pub const MA_FALLTHROUGH = @compileError("unable to translate macro: undefined identifier `fallthrough`"); // /home/faouzi/miniaudio/miniaudio.h:3904:17
pub const MA_GNUC_INLINE_HINT = @compileError("unable to translate C expr: unexpected token 'inline'"); // /home/faouzi/miniaudio/miniaudio.h:3936:17
pub const MA_INLINE = @compileError("unable to translate macro: undefined identifier `always_inline`"); // /home/faouzi/miniaudio/miniaudio.h:3940:17
pub const MA_NO_INLINE = @compileError("unable to translate macro: undefined identifier `noinline`"); // /home/faouzi/miniaudio/miniaudio.h:3941:17
pub const MA_API = @compileError("unable to translate C expr: unexpected token 'extern'"); // /home/faouzi/miniaudio/miniaudio.h:3981:17
pub const MA_PRIVATE = @compileError("unable to translate C expr: unexpected token 'static'"); // /home/faouzi/miniaudio/miniaudio.h:3989:17
pub const alignas = @compileError("unable to translate C expr: unexpected token '_Alignas'"); // /snap/zig/10276/lib/include/stdalign.h:18:9
pub const alignof = @compileError("unable to translate C expr: expected '(' instead got ''"); // /snap/zig/10276/lib/include/stdalign.h:19:9
pub const MA_ATOMIC = @compileError("unable to translate C expr: unexpected token '_Alignas'"); // /home/faouzi/miniaudio/miniaudio.h:4058:13
pub const MA_ATOMIC_SAFE_TYPE_DECL = @compileError("unable to translate macro: undefined identifier `ma_`"); // /home/faouzi/miniaudio/miniaudio.h:4369:9
pub const MA_ATOMIC_SAFE_TYPE_DECL_PTR = @compileError("unable to translate macro: undefined identifier `ma_`"); // /home/faouzi/miniaudio/miniaudio.h:4375:9
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /snap/zig/10276/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /snap/zig/10276/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /snap/zig/10276/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/10276/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/10276/lib/include/stdarg.h:46:9
pub const MA_ATTRIBUTE_FORMAT = @compileError("unable to translate macro: undefined identifier `format`"); // /home/faouzi/miniaudio/miniaudio.h:4466:17
...
pub const MA_VERSION_REVISION = @as(c_int, 21);
