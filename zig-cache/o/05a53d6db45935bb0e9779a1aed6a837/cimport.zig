...
pub const offsetof = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /snap/zig/10297/lib/include/stddef.h:116:9
...
pub const alignas = @compileError("unable to translate C expr: unexpected token '_Alignas'"); // /snap/zig/10297/lib/include/stdalign.h:18:9
pub const alignof = @compileError("unable to translate C expr: expected '(' instead got ''"); // /snap/zig/10297/lib/include/stdalign.h:19:9
...
pub const va_start = @compileError("unable to translate macro: undefined identifier `__builtin_va_start`"); // /snap/zig/10297/lib/include/stdarg.h:33:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`"); // /snap/zig/10297/lib/include/stdarg.h:35:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'"); // /snap/zig/10297/lib/include/stdarg.h:36:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/10297/lib/include/stdarg.h:41:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`"); // /snap/zig/10297/lib/include/stdarg.h:46:9
